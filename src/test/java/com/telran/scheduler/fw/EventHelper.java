...
public class EventHelper extends HelperBase {
    ...
    public boolean isErrorMessagePresent() {
        return isElementPresent(By.id("parentPanel"));
    }

    public boolean isCurrencyContainerPresent() {
        return isElementPresent(By.id("wizard_settings_currency_container"));
    }
